...
namespace Gesture_Typing.Serial
{
    /// <summary>
    ...
    public class SerialSettings : INotifyPropertyChanged
    {
        ...
        int _baudRate = 9600;
        int[] _baudRateCollection = new int[] { 9600, 14400, 19200, 38400, 56000, 57600, 115200, 128000 };
        ...
        /// </summary>
        public int[] BaudRateCollection
        {
            get { return _baudRateCollection; }
            set { _baudRateCollection = value; }
        }
